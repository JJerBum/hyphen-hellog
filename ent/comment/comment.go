...
// ByChildrensCount orders the results by childrens count.
func ByChildrensCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newChildrensStep(), opts...)
	}
}

// ByChildrens orders the results by childrens terms.
func ByChildrens(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newChildrensStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newChildrensStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(Table, FieldID),
