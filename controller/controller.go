...
func Route(app *fiber.App) *fiber.App {
	...
	// like
	api.Patch("/posts/:post_id/unliked", middleware.RequireAuth, handlers.UpdateUnliked)
	api.Patch("/posts/:post_id/liked", middleware.RequireAuth, handlers.UpdateLiked)
